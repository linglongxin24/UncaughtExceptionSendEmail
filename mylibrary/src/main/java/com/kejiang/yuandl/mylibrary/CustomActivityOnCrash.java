                            ...
                            if (!CustomActivityOnCrash.debugModel) {
                                new Thread() {
                                    public void run() {
                                        ...
                                        ReportByEmail.sendEmail2(CustomActivityOnCrash.getApplicationName(context), CustomActivityOnCrash.getAllErrorDetailsFromContext(context, stackTraceString));
...
/* Location:              E:\kejiang\AndroidStudioProjects\inspection\app\libs\UncaughtExceptionSendEmail\classes.jar!\cat\ereza\customactivityoncrash\CustomActivityOnCrash.class
